...
List of sources which will be added to config file and loaded when fluentd service started, for example:
...
List of matches which will be added to config file and loaded when fluentd service started, for example:
